...
class UIControlId(object):
    ...
    def instance(cls, *args, **kwargs):
        if not hasattr(UIControlId, "_instance"):
            UIControlId._instance = UIControlId(*args, **kwargs)
        return UIControlId._instance
...
class UIButton(object):
    def __init__(self, parent, rect, text = "Button", click = None):
        ...
        self.ctl_id = UIControlId().instance().get_new_id()
        self._text = text
        self._click = click
        self._visible = True
        self.init_font()
    ...
    def init_font(self):
        font = pygame.font.SysFont('Arial Rounded MT Bold',28)
        white = 100, 100, 100
